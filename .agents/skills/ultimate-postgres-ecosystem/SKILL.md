...
description: Activate this skill for PostgreSQL, Supabase, Neon databases, complex SQL queries, migrations, or Row Level Security (RLS).
---
...
Look the page up before you fetch it — **don't guess URLs!** The docs index lists every available page with its URL and a short description: Activate this skill for PostgreSQL, Supabase, Neon databases, complex SQL queries, migrations, or Row Level Security (RLS).
---
